...
describe('PayNowDecoder', () => {
  ...
  it('should decode a PayNow payload with amount and reference', () => {
    const payload = '00020101021226540009SG.PAYNOW01012020912345678A03011041420241130230000520400005303702540599.995802SG5912TEST COMPANY6009Singapore62140110TESTQRCODE63042A56';
  ...
  it('should decode a PayNow payload with mobile number', () => {
    const payload = '00020101021226560009SG.PAYNOW010100211+654343210003011041420241130193200520400005303702540820000.015802SG59006009Singapore62250121TESTQRCODEPHONENUMBER63041F4C';
